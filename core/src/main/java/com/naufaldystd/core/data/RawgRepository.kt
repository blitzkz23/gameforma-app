...
class RawgRepository @Inject constructor(
	...
	override fun getAllGame(): Flow<Resource<List<GameResponse>>> {
		TODO("Not yet implemented")
	}

	override fun getFavoriteGame(): Flow<List<GameResponse>> {
		TODO("Not yet implemented")
	}

	override fun setFavoriteGame(game: GameResponse, state: Boolean) {
		TODO("Not yet implemented")
	}
}